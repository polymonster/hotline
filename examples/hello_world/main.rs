...
fn main() -> Result<(), hotline_rs::Error> {
    ...
    */
    ...
    let files = vec![
        asset_path.join("..\\..\\..\\examples\\hello_world\\redchecker01.png"),
        asset_path.join("..\\..\\..\\examples\\hello_world\\blend_test_fg.png"),
        asset_path.join("..\\..\\..\\examples\\hello_world\\bear_stomp_anim_001.png"),
        asset_path.join("..\\..\\..\\examples\\hello_world\\bluechecker01.png"),
    ];
    for file in files {
