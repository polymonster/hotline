...
fn main() -> Result<(), hotline_rs::Error> {
    ...
    while app.run() {
        ...
        cmdbuffer.set_binding(pso_pmfx, 0, 0, gfx::DescriptorType::ShaderResource, dev.get_shader_heap(), srv0);
        cmdbuffer.set_binding(pso_pmfx, 1, 0, gfx::DescriptorType::ShaderResource, dev.get_shader_heap(), srv1);
